...
public class OssController {
    ...
    public Resp<Object> policy() {
        String accessId = "LTAI4FcP6DDyGpPk2KBXW6NT"; // 请填写您的AccessKeyId。
        String accessKey = "dpRCZqhvv7ccBSfFBiv7klPZxy23Ok"; // 请填写您的AccessKeySecret。
        String endpoint = "oss-cn-beijing.aliyuncs.com"; // 请填写您的 endpoint。
        String bucket = "diyitongjin"; // 请填写您的 bucketname 。
